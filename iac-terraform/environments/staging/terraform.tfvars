...
github_repository_subjects = [
  ...
  "repo:godspower/aws-gp-k8s:ref:refs/heads/staging"
]

# Security settings for staging
create_access_keys = false # No access keys for staging (use IAM roles instead)
enforce_mfa        = true
...
domains = {
  ...
  public = {
    ...
    subdomains          = ["www", "api", "app", "staging"]
  ...
  secondary = {
    ...
    cname_records = [
      {
        name  = "www.staging.example2.com"
        value = "staging.example2.com"
        ttl   = 300
      }
    ]
  }
